...
var Request = new Class({
	...
	processScripts: function(text){
		if (this.options.evalResponse || (/(ecma|java)script/).test(this.getHeader('Content-type'))) return text; // $avital - $exec(text);
...
var mootreegif = 'data:image/gif;base64,';

var mootreeloadergif = 'data:image/gif;base64,%3D';
...
var MooTreeControl = new Class({
	...
	initialize: function(config, options) {
		...
		this.theme = config.theme || mootreegif;

		this.loader = config.loader || {icon:mootreeloadergif, text:'Loading...', color:'#a0a0a0'};
...
<body>
<span id=\"json\" style=\"display: none;\">
@@@result@@@
</span>
